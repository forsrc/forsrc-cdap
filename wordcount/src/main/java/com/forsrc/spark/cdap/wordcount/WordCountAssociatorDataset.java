...
public class WordCountAssociatorDataset extends AbstractDataset {

    private Table table;

    public WordCountAssociatorDataset(DatasetSpecification spec, @EmbeddedDataset("word_assoc") Table table) {
     ...
     * word in the set, an association will be stored for each of the other words in
     * the set.
     * 
     * @param words
     *            words to store associations between
     */
    @WriteOnly
    ...
    /**
     * Returns the top words associated with the specified word and the number of
     * times the words have appeared together.
     * 
     * @param word
     *            the word of interest
     * @param limit
     *            the number of associations to return, at most
